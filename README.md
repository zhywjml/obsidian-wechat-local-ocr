...
> * **本插件 (Local OCR)**：专注于**单张图片的交互式提取**。适合阅读时对特定图片进行框选、复制、识别。
> * **另一个插件 (Global Search)**：专注于**全库图片的索引与检索**。适合输入关键词查找“那张图在哪”，并支持文件中的图片定位。
> 如果你需要全库搜索功能，请前往：
> 👉 **[WeChat OCR Global Search (全库图片搜索)](https://github.com/zhywjml/obsidian-local-wechatocr-search)**
